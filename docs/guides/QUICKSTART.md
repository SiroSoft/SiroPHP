...
```
> **New in v0.35.0**: Packages auto-register CLI commands and service providers.
...
SiroPHP **v0.35.0+** auto-discovers CLI commands and service providers from any installed Composer package.
