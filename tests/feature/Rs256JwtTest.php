...
final class Rs256JwtTest extends TestCase
{
    ...
    public function testJwtClassHasEncodeRefreshMethod(): void { $this->assertTrue(method_exists(JWT::class, 'encodeRefresh')); } // @phpstan-ignore function.alreadyNarrowedType
    public function testJwtClassHasDecodeMethod(): void { $this->assertTrue(method_exists(JWT::class, 'decode')); } // @phpstan-ignore function.alreadyNarrowedType
