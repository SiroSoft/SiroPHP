...
// Generated by: php siro make:api test
$app->router->get('/test', [\App\Controllers\TestController::class, 'index']);
$app->router->get('/test/{id}', [\App\Controllers\TestController::class, 'show']);
$app->router->post('/test', [\App\Controllers\TestController::class, 'store']);
$app->router->put('/test/{id}', [\App\Controllers\TestController::class, 'update']);
$app->router->delete('/test/{id}', [\App\Controllers\TestController::class, 'delete']);
