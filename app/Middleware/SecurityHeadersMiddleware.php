...
final class SecurityHeadersMiddleware implements MiddlewareInterface
{
    ...
    public function handle(Request $request, callable $next): Response
    {
        ...
        $response->header('Content-Security-Policy', "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; font-src 'self'; connect-src 'self'; frame-ancestors 'none'; form-action 'self'");
